...
// TODO: Refactor the whole project to use this code
// TODO: Create and implement layout for each pages
...
final router = GoRouter(
  routes: [
    ...
    // TODO: Create PortfolioPage
    // GoRoute(path: "/vendor", builder: (context, state) => PortfolioPage()),
    ...
    // TODO: Create CheckoutPage
    // GoRoute(path: "/checkout/:dataId", builder: (context, state) => CheckoutPage(dataId: int.parse(state.pathParameters['dataId']!),)),
  ],
);
